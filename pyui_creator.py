...
def updateApplication():
    """
    This function works for automating *.ui files generator to *.py

    :return: none
    """
    layout_creator_path = os.path.dirname(__file__)

    ui_file = os.path.join(layout_creator_path, "beamPyUI.ui")
    py_ui_file = os.path.join(layout_creator_path, "beamPyUI.py")
